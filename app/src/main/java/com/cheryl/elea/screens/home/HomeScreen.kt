...
fun HomeScreen(navController: NavController){
        ...
        topBar = {
            TopAppBar(
                ...
                colors = TopAppBarDefaults.topAppBarColors(
                    containerColor = navy,
                    titleContentColor = nude,
                    navigationIconContentColor = nude
    ...
    Column(modifier = Modifier.fillMaxSize()
        ...
        Row (modifier = Modifier.background(nude).padding(top = 12.dp, bottom = 1.dp, start = 30.dp)){
            Text(
                text = "  COMFORT      LUXURY     ELEGANCE ",
                fontSize = 18.sp,
        ...
        Box{
            ...
            Card (
                ...
                Text(text = "Home", fontSize = 20.sp,
                    fontStyle = FontStyle.Italic, color = nude)
        ...
        Text(text = "Available Services:", fontSize = 22.sp,
             color = navy, fontWeight = FontWeight.Normal, )
        ...
        Row(modifier = Modifier.padding(start = 10.dp, top = 1.dp)
            ...
            Row {
                ...
                Card (
                    ...
                    Image(
                        painter = painterResource(R.drawable.hairbck2),
                        contentDescription = "img",
                ...
                Card (
                    ...
                    Image(
                        painter = painterResource(R.drawable.massagebck),
                        contentDescription = "img",
                        modifier = Modifier.width(165.dp).height(280.dp),
        ...
        Row(modifier = Modifier.padding(start = 10.dp, top = 1.dp)
            ...
            Row {
                ...
                Card(
                    ...
                    Image(
                        painter = painterResource(R.drawable.makeupbck),
                        contentDescription = "img",
                        modifier = Modifier.width(165.dp).height(280.dp),
                ...
                Card(
                    ...
                    Image(
                        painter = painterResource(R.drawable.nailsbck3),
                        contentDescription = "img",
                        modifier = Modifier.width(165.dp).height(280.dp),
